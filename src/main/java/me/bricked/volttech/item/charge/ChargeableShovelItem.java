...
public class ChargeableShovelItem extends ShovelItem implements IChargeableItem {
    protected boolean isInfiniteEnergy;

    public ChargeableShovelItem(ToolMaterial tier, Properties properties, float attackDamage, float attackSpeed) {
