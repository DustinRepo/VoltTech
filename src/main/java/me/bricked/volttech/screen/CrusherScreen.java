...
public class CrusherScreen extends AbstractContainerScreen<CrusherMenu> {
    public CrusherScreen(CrusherMenu menu, Inventory playerInventory, Component title) {
        ...
        this.constraints = Constraints.get(BlockRegistry.CRUSHER.get());
    }
    private final Constraints constraints;
    private final ResourceLocation TEXTURE = VoltTech.resourceLocation("textures/gui/crusher_gui.png");
    ...
    protected void renderBg(GuiGraphics guiGraphics, float v, int i, int i1) {
        ...
        int x = 76;
        int y = 37;
        float progress = Mth.clamp((float) menu.getCrushingTicks() / (float) menu.getMaxCrushingTicks(), 0, 1);
