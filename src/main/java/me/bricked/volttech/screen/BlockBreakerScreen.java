...
public class BlockBreakerScreen extends AbstractContainerScreen<BlockBreakerMenu> {
    public BlockBreakerScreen(BlockBreakerMenu menu, Inventory playerInventory, Component title) {
        super(menu, playerInventory, title);
        this.constraints = Constraints.get(BlockRegistry.BLOCK_BREAKER.get());
    }
    private final Constraints constraints;
    private final ResourceLocation TEXTURE = VoltTech.resourceLocation("textures/gui/block_breaker_gui.png");
