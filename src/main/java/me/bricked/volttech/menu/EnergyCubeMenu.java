...
public class EnergyCubeMenu extends AbstractContainerMenu {
    ...
    public EnergyCubeMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, new SimpleContainer(2), new SimpleContainerData(4));
    }

    public EnergyCubeMenu(int containerId, Inventory playerInventory, Container container, ContainerData containerData) {
        super(MenuRegistry.ENERGY_CUBE_MENU.get(), containerId);
