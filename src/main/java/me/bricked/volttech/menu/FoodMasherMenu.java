...
public class FoodMasherMenu extends AbstractContainerMenu {
    private final Container container;
    private final ContainerData containerData;

    public FoodMasherMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, new SimpleContainer(2), new SimpleContainerData(3));
    }

    public FoodMasherMenu(int containerId, Inventory playerInventory, Container container, ContainerData containerData) {
        super(MenuRegistry.FOOD_MASHER_MENU.get(), containerId);
        ...
        RecipeManager.CachedCheck<SingleRecipeInput, ? extends FoodMasherRecipe> quickCheck =
                RecipeManager.createCheck(RecipeRegistry.FOOD_MASHER_RECIPE.get());
        ...
        this.addSlot(new Slot(container, 1, 107, 35) {
            @Override
            public boolean mayPlace(ItemStack stack) {
                return false;
            }
    ...
    public int getMashingTicks() {
        return containerData.get(1);
    }

    public int getMaxMashingTicks() {
